...
$string['privacy:metadata:block_ai_chat_personas'] = 'Information about user-defined AI chat personas is stored.';
$string['privacy:metadata:block_ai_chat_personas:name'] = 'The persona name.';
$string['privacy:metadata:block_ai_chat_personas:prompt'] = 'The persona prompt content.';
$string['privacy:metadata:block_ai_chat_personas:timecreated'] = 'The time when the persona was created.';
$string['privacy:metadata:block_ai_chat_personas:timemodified'] = 'The time when the persona was last modified.';
$string['privacy:metadata:block_ai_chat_personas:type'] = 'The persona type.';
$string['privacy:metadata:block_ai_chat_personas:userid'] = 'The ID of the user who owns the persona.';
$string['privacy:metadata:block_ai_chat_personas:userinfo'] = 'Additional persona information shown to users.';
