...
$string['ragsourceslabel'] = 'Sources';
$string['ragsourcesmore'] = 'Show more sources';
$string['replacehelp'] = 'Replace help button with block_ai_chat button';
$string['sourceselectioninfo'] = 'Attach context sources';
$string['sourceselectionsaveerror'] = 'The source selection could not be saved.';
$string['sourceselectiontitle'] = 'Attach context sources';
