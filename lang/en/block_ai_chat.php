...
$string['agentmodeunavailableonpagemessage'] = 'You cannot use the agent mode here, because it is not working with this page type.';
$string['agentmodeunavailableonpagetitle'] = 'Agent mode unavailable';
$string['agentmodeunavailablepagetypes'] = 'Pagetypes on which the agent mode will be unavailable';
$string['agentmodeunavailablepagetypesdesc'] = 'Insert page ids (one string per line) on which the agent mode should not be available. The string has to exactly match the id attribute of the body tag.';
$string['agenttoolagent_alwaystrustsession'] = 'Always allow in this session';
$string['agenttoolagent_approve'] = 'Approve';
$string['agenttoolagent_disabled'] = 'The tool-agent is currently disabled or not configured.';
$string['agenttoolagent_pendingapproval'] = 'The assistant wants to run "{$a}" and is waiting for your confirmation.';
$string['agenttoolagent_reject'] = 'Reject';
$string['agenttoolagent_reloadhint'] = 'The agent has made changes to this page. Reload to see the updated state.';
$string['agenttoolagent_reloadnow'] = 'Reload page';
$string['agenttoolagent_runfailed'] = 'The tool-agent run failed: {$a}';
$string['agenttoolagent_willperform'] = 'The assistant will now perform the following action:';
$string['agentabortrun'] = 'Abort run';
$string['agentundotoolresult'] = 'Undo ({$a}s)';
$string['agentundodone'] = 'Undone';
...
$string['ai_chat:useformassist'] = 'Use form-assist mode (in-form suggestions)';
$string['ai_chat:useagent'] = 'Use tool-agent mode (server-side tool execution)';
$string['ai_chat:approvewrite'] = 'Approve write-operations proposed by the tool-agent';
$string['ai_chat:trustsession'] = 'Trust tools for the current session';
...
$string['error_conversationmodelocked'] = 'This conversation is locked to the "{$a->stored}" mode; the requested "{$a->requested}" mode is not allowed. Please start a new conversation.';
$string['error_invalidmode'] = 'The requested AI mode "{$a}" is not supported.';
...
$string['modetoolagent'] = 'Tool-Agent';
$string['modetoolagentinfo'] = 'Click to toggle between "chat" and "tool-agent" mode';
$string['name'] = 'Name';
...
$string['personaprompt_help'] = 'You can use a full text editor for formatting your persona prompt. Please consider that the complete formatting will be sent as HTML to the external AI system.<br/>For best results it is recommended to use only basic formatting that helps to structure the prompt.';
